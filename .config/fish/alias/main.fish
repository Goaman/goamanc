...
abbr esa "vim ~/.config/fish/alias/main.fish;source ~/goamanc/config/fish/alias/main.fish"
...
# abbr se "sensation --debug --config $HOME/goamanc/sensation/config.py 4"
# #function sensation
...
# abbr goser cd $HOME/goamanc/services
...
# abbr stu sudo systemctl status
